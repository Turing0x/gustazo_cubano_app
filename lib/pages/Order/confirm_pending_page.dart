...
class ConfirmPendingPage extends StatefulWidget {
  const ConfirmPendingPage({super.key, required this.orderId});
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: FormTxt(controller: invoceNumber, label: 'Número de factura'),
              ),
              ElevatedButton.icon(
                  onPressed: () {
                    ...
                    if (number.isEmpty) {
                      simpleMessageSnackBar(context,
                          texto: 'Debe escribir el número de la factura en el campo disponible', typeMessage: false);
                      return;
                    }
