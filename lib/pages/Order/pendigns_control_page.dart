...
class _PendingControlPageState extends ConsumerState<PendingControlPage> {
  ...
  void initState() {
    ...
    OrderControllers().getAllOrders(false, date: date).then((value) {
      setState(() {
        list = value;
        list2 = value;
      });
    ...
    return Scaffold(
        ...
        body: Column(
          children: [
            ...
            (list.isEmpty) ? noData(context, 'No tenemos pedidos en este momento. Vuelva en otro momento') : showList(),
          ],
        ));
  }
                ...
                itemBuilder: (context, index) {
                  ...
                  return Container(
                    ...
                    child: ListTile(
                      ...
                      subtitle: dosisBold('Pedido: ', order.pendingNumber, 18),
                      trailing: CircleAvatar(
                          child: dosisText(order.productList.length.toString(), fontWeight: FontWeight.bold)),
                      onTap: () => Navigator.pushReplacementNamed(context, 'pending_details_page', arguments: [order]),
                    ),
                  );
                },
              )),
        ...
        return [
          PopupMenuItem(
            ...
            child: Row(
              ...
              children: [dosisText('Número de pedido'), Visibility(visible: filterType == 'num', child: icon2)],
            ),
          ),
          PopupMenuItem(
            value: 'seller',
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [dosisText('Nombre del vendedor'), Visibility(visible: filterType == 'seller', child: icon2)],
            ),
          ),
          PopupMenuItem(
            value: 'buyer',
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [dosisText('Nombre del comprador'), Visibility(visible: filterType == 'buyer', child: icon2)],
            ),
          ),
        ];
      },
