            ...
            child: Column(
              children: [
                ...
                Padding(
                  ...
                  child: dosisText(
                    'Necesitamos información personal acerca del comercial para poder hacer su registro', 
                  ...
                  onPressed: () async{
                    ...
                    if(
                      ...
                      simpleMessageSnackBar(context, 
                        texto: 'Es obligatorio rellenar todos los campos',
                        typeMessage: false);
                      return;
                    }
                    ...
                    if(
                      ...
                      simpleMessageSnackBar(context, 
                        texto: 'El carnet de identidad es incorrecto, rectifíquelo por favor',
                        typeMessage: false);
                      return;
                    }
                    ...
                    if(
                      ...
                      simpleMessageSnackBar(context, 
                        texto: 'El número de celular es incorrecto, rectifíquelo por favor',
                        typeMessage: false);
                      return;
                    }
