...
class _AuthPageState extends ConsumerState<AuthPage> {
  ...
  Text mainTitle() {
    return const Text("E' Gustazo Cubano",
        style: TextStyle(
          color: Colors.white,
          fontFamily: 'Dosis',
          fontSize: 27,
                ...
                child: Container(
                  ...
                  child: ElevatedButton.icon(
                    style: ElevatedButton.styleFrom(
                      backgroundColor: (!btnManager) ? const Color.fromARGB(255, 91, 79, 226) : Colors.grey[400],
                      elevation: 2,
                    ),
                    icon: const Icon(
                      Icons.login,
...
class CurvePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    var gradient = const LinearGradient(
      ...
      colors: [Color(0xFF473ACD), Color.fromARGB(255, 115, 93, 215)],
    );
